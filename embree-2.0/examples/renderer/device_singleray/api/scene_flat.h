  ...
  public:
    ...
    public:
      ...
      void create() 
      {
        ...
        RTCIntersectorStream* intersectorStream = rtcQueryIntersectorStream(mesh,traverserTy.c_str());
        
        /* create new scene */
        instance = new BackendSceneFlat(prims,mesh,intersector1,intersectorStream);
      }
    ...
    BackendSceneFlat (const std::vector<Ref<Primitive> >& geometry, RTCGeometry* accel, RTCIntersector1* intersector1, RTCIntersectorStream* intersectorStream)
